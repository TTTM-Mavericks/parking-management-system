...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentReponseDTO paymentReponseDTO;

    @Override
    public PaymentReponseDTO save(PaymentDTO dto) {
        ...
        paymentReponseDTO = new PaymentReponseDTO(Id_Booking, booking.getCustomer_slot().getId_C_Slot(), booking.getStartDate(),
    ...
    @Override
    public PaymentReponseDTO findPayment() {
        return paymentReponseDTO;
    }
}
